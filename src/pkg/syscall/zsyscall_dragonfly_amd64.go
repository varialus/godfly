// mksyscall.pl syscall_bsd.go syscall_dragonfly.go syscall_dragonfly_amd64.go
...
// Copied from zsyscall_freebsd_amd64.go

// THIS FILE IS NOT GENERATED BY THE COMMAND AT THE TOP; DO EDIT
