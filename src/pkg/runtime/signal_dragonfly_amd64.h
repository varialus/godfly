...
#define SIG_XFLAGS(info, ctxt) (SIG_REGS(ctxt).mc_xflags)
#define	SIG_TRAPNO(info, ctxt) (SIG_REGS(ctxt).mc_trapno)
#define SIG_ADDS(info, ctxt) (SIG_REGS(ctxt).mc_addr)
#define SIG_FLAGS(info, ctxt) (SIG_REGS(ctxt).mc_flags)
#define SIG_ERR(info, ctxt) (SIG_REGS(ctxt).mc_err)
...
#define SIG_SS(info, ctxt) (SIG_REGS(ctxt).mc_ss)
